					...
					if($nome!=null && $pass!=null && $id_libro!=null)
						{
							...
							mysql_select_db($db_name, $db) or die ('ERRORE SELEZIONE DB');
										...
										$query4 = "SELECT id_libro FROM Utenti WHERE id_libro >1 AND nome='$nome' AND password='$pass'"; 
										...
										if($num4 < 1)
										{
											...
											$num= mysql_num_rows($result);
												...
												echo("<br><h2> Spiacenti! non è possibile noleggiare più di un libro alla volta.</h2><br>");
												}
							}
						else{
